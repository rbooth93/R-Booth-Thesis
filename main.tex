...
\thesistitle{Magnetic activity of cool stars on the main sequence} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\vspace*{.06\textheight}
{\textcolor{red}\scshape\LARGE \textbf{\ttitle}\par}\vspace{1.5cm}
