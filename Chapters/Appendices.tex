...
\caption[Details of activity and rotation parameters for sample of stars][Activity and rotation indicator values for activity-rotation relationship]{\begin{footnotesize} 	Activity and rotation indicator values for sample of stars considered for the activity-rotation analysis. References indicate the sources for the rotation period, chromospheric emission and X-ray emission, respectively. 
\noindent
