...
The chromospheric emission from \caII lines was measured for a sample of 25 stars with asteroseismic ages. The sample contains primarily F and G stars, as well as one K star.
...
In total, 26 stars were fully analysed and the details of this sample are shown in Appendix REF. Four stars have observations from both \esp and \narval spectrographs: KIC 5774694, KIC 8006161, KIC 9139163 and KIC 10454113. For simplicity, only the \narval data is shown in plots for these stars.
