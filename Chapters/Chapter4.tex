...
\begin{figure}
    ...
    \caption{The \Rprime indicator as a function of B-V colour. Different spectral types are indicate by various colours. Stars with $T_{eff}$ greater than 6500~K are shown in red.}
    \label{fig:ca_v_bv}
\end{figure}
