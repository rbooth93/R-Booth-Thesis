...
\label{Chp4_data_analysis_calibration_to_Smw}

\begin{figure}
    \centering
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=0.9]{Figures/4-Chromospheric_age/espadons_calibrator_reltionship.pdf}
        \caption{\esp Calibrators}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=0.9]{Figures/4-Chromospheric_age/narval_calibrator_reltionship.pdf}
        \caption{\narval Calibrators}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=0.53]{Figures/4-Chromospheric_age/ca_results_LO_mass_w_hotstars.pdf}
        \caption{Effect of mass on the age--activity relationship}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=0.53]{Figures/4-Chromospheric_age/ca_results_LO_metallicity_w_hotstars.pdf}
